  ...
  return (
    <div className="relative min-h-screen z-10">
      ...
      <header className="border-b border-white/10 backdrop-blur-xl bg-white/5 ">
        <div className="container mx-auto px-3 py-3 md:px-6 md:py-5">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1.5 led-card px-2 py-1 md:px-3 md:py-1.5 ml-2">
          ...
          <div className="container mx-auto px-3 py-3">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
                <div className="lead-card animate-spin rounded-full h-4 w-4 border-2 border-purple-500 border-t-transparent"></div>
      ...
      <div className="spark-container">
        ...
        {/* Filtre Avansate */}
        <div className="led-card animate-float p-4 md:p-6 mb-4 md:mb-6">
        ...
        <section>
                ...
                <div className="flex items-center justify-between pt-2 md:pt-3 border-t border-white/10">
                  ...
                  {lead.status === 'pending' && (
                    <button
                      ...
                      className="border-2 border-green-500 bg-green-600/20 text-green-400 hover:bg-green-600/40 hover:border-green-400 active:bg-green-700 active:border-green-300 transition-all duration-200 text-[10px] md:text-xs py-1.5 md:py-2 px-2.5 md:px-3 rounded-lg font-medium"
                    >
                      📤 SMS
                    </button>
                  )}
          ...
          {filteredLeads.length > displayCount && (
            <div className="mt-6 md:mt-8 flex flex-col items-center gap-3">
              ...
              <button
                ...
                className="btn-scraping text-xs md:text-sm py-2.5 md:py-3 px-6 md:px-8 flex items-center gap-2"
              >
                <span>📥</span>
          ...
          {filteredLeads.length === 0 && (
            <div className="led-card py-8 md:py-12 px-4 text-center">
